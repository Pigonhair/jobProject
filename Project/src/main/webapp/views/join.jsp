	...
	<div class="form-structor">
		<div class="signup">
			...
			<div class="form-holder">
				<div class="join-form">
					<span><input class="join-id" type="text"> @ <input
						class="join-id2" name="join-id2" type="text"> <select
				...
				<input type="password" id="member_pwd1" class="input"
					placeholder="비밀번호" /> <input type="password" id="member_pwd2"
					class="input" placeholder="비밀번호 확인" onKeyUp="fn_compare_pwd();" />
				<span id="s_result"></span> <input type="text" class="input"
					placeholder="이름" /> <input type="text" class="input"
					placeholder="주소" /> <input type="text" name="date"
					placeholder="생년월일" class="input datepicker" size="12" />
				<div class="join-form">
