...
<form class='login-form'  >
  <div class="flex-row">
    ...
    <input id="username" name ="m_id" class='lf--input' placeholder='Username' type='text' onKeyUp="idkeyUP()">
  </div>
  ...
  <div class="flex-row">
    ...
    <input id="password" name ="m_pwd" class='lf--input' placeholder='Password' type='password' onKeyUp="pwdkeyUP()">
  </div>
  <span id="pwdresult" class="result"></span>
  <input class='lf--submit' type='button' value='LOGIN' id="loginBtn" onClick="loginClick()">
